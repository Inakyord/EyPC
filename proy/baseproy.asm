...
endm
;oculta_cursor_mouse - Oculta la visibilidad del cursor del mouse
oculta_cursor_mouse 	macro
	mov ax,02h 		;Opcion 02h
	int 33h 		;int 10, opcion 01h. Cambia la visibilidad del cursor del mouse
endm
